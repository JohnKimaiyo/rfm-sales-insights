...
-- group dealsize by revenue ---
select  DEALSIZE,  sum(sales) Revenue
from [dbo].[sales_data_sample]
group by  DEALSIZE
order by 2 desc

----What was the best month for sales in a specific year? How much was earned that month?  year 2003 --
...
----What was the best month for sales in a specific year? How much was earned that month?  year 2004 --
select  MONTH_ID, sum(sales) Revenue, count(ORDERNUMBER) Frequency
from .[dbo].[sales_data_sample]
where YEAR_ID = 2003 --change year to see the rest
group by  MONTH_ID
...
--November seems to be the month, what product do they sell in November, Classic I believe 2003 --
...
--November seems to be the month, what product do they sell in November, Classic I believe 2004 --
select  MONTH_ID, PRODUCTLINE, sum(sales) Revenue, count(ORDERNUMBER)
from [dbo].[sales_data_sample]
